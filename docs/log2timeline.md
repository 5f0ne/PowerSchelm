...
| Parser      | String | ""                     | Provide a list of l2t parsers which shall be used. e.g.: winreg,winevtx,mft,usnjrnl,prefetch. (If no parsers are provided all parsers will be used) |